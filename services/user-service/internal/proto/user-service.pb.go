...
const file_internal_proto_user_service_proto_rawDesc = "" +
	...
	"\x02ok\x18\x02 \x01(\bR\x02ok2\xa6\x01\n" +
	"\vUserService\x12I\n" +
	"\bSaveUser\x12\x1d.user_service.SaveUserRequest\x1a\x1e.user_service.SaveUserResponse\x12L\n" +
	"\tLoginUser\x12\x1e.user_service.LoginUserRequest\x1a\x1f.user_service.LoginUserResponseB\x17Z\x15/internal/proto;protob\x06proto3"
...
var file_internal_proto_user_service_proto_depIdxs = []int32{
	...
	3, // 3: user_service.UserService.LoginUser:output_type -> user_service.LoginUserResponse
