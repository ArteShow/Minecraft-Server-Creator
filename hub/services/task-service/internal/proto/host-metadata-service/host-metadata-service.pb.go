...
const file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDesc = "" +
	"\n" +
	"@internal/proto/host-metadata-service/host-metadata-service.proto\x12\x15host_metadata_service\"\x19\n" +
...
var (
	...
	file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDescData []byte
)
...
func file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDescGZIP() []byte {
	file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDescOnce.Do(func() {
		file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDesc), len(file_internal_proto_host_metadata_service_host_metadata_service_proto_rawDesc)))
	})
